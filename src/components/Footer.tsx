        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#tickets" className="hover:text-white">Registration</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-white">Venue Information</a></li>
              <li><a href="#" className="hover:text-white">Travel & Hotels</a></li>
